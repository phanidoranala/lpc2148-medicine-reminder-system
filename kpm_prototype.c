...
void initKPM(void);          // initialize keypad
unsigned int colscan(void);  // check if any key is pressed
unsigned int rowcheck(void); // detect pressed row
unsigned int colcheck(void); // detect pressed column
unsigned int keyscan(void);  // scan keypad and return key
unsigned int readnum(void);  // read number from keypad
